import { Avatar, Divider, Flex, Skeleton, SkeletonCircle, Text, useColorModeValue, useToast } from "@chakra-ui/react"
...
import messageNotification from '../assets/audio/notification.mp3'
...
const MessageContainer = () => {
    ...
    useEffect(() => {
        ...
        getMessages()
    }, [selectedConversation.userId, toast, selectedConversation.mock])
    ...
    return (
        ...
        borderRadius={'md'} flexDirection={'column'} p={2}>
            <Flex w={'full'} h={12} alignItems={'center'} gap={2}>
                ...
                <Text display={'flex'} alignItems={'center'}>{selectedConversation.username}</Text>
            </Flex>
